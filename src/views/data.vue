				...
				<el-col :span="16" style="padding-left: 50px;padding-top: 50px;">
					<el-row>
						<el-row>
							<el-row>
								<div class="big_title" style="font-size: 20px;float:left;color: white;">
									<el-row>
										<span style="text-shadow: .3rem 0 0.3rem #00d8ff;">数据集列表</span>
									</el-row>
						...
						<el-row>
							...
							<div class=".regional_table">
								...
								style=""
								 v-loading="loading" :data="tabledata1" @selection-change="handleSelectionChange"
								:header-cell-style="{color: '#ffffff', fontSize: '14px', backgroundColor: 'rgba(7, 55, 77, 1.0)',borderColor:'#536a6f'}">
								>
					...
					<el-row style="padding-top: 40px;">
						<el-row>
							<div class="big_title" style="font-size: 20px;float:left;color: white;">
								<el-row>
									<span style="text-shadow: .3rem 0 0.3rem #00d8ff;">测试集列表</span>
								</el-row>
								<el-row style="padding-bottom: 20px;padding-top: 0px;">
									<el-col span="4">
										<img src="../assets/images/line1.png" style="width: 110%;padding-bottom: 5px;" />
				...
				<el-col :span="8" style="padding-top: 50px;padding-right: 30px;height: 700px;" >
					<el-row class="div1" style="height: 100%;width: 400px;">
						<el-row style="font-size: 16px;float:left;color: white;padding-top: 20px;padding-left: 10px;padding-right: 10px;">
							<span style="text-shadow: .3rem 0 0.3rem #00d8ff;padding-left: 140px;font-size: 19px;">新增数据集</span>
							<div style="padding-top: 30px;">
								<el-form ref="form" :model="form" :rules="rules" label-width="0px" style="padding-left: 30px;">
								  <!-- <div prop="name">
									  <span style="font-size: 16px;">数据集名称</span>
									  <el-input v-model="form.name" placeholder="请输入数据集名称" style="padding-top: 10px;" />
								  </div> -->
								  ...
								  <el-form-item prop="content">
								  	<span style="font-size: 16px;">数据集描述</span>
								    <el-input v-model="form.content" placeholder="请描述数据集" />
								  </el-form-item>
								  <el-form-item prop="source">
								  	<span style="font-size: 16px;">数据集来源</span>
								    <el-input v-model="form.source" placeholder="请选择数据集来源" />
								  </el-form-item>
								  <el-form-item prop="type">
								  	<span style="font-size: 16px;">数据集类别</span>
								    <el-input v-model="form.type" placeholder="请选择数据集类别" />
								  </el-form-item>
								  <el-form-item prop="type">
								  	<span style="font-size: 16px;">上传数据集</span>
									<!-- <div style="zoom:0.8">
										<el-upload
										  class="upload-demo"
										  drag
									...
									<el-upload
										...
										<div slot="tip" class="el-upload__tip">只能上传.zip文件，且不超过5M</div>
										<!-- <div slot="tip" class="el-upload__tip">只能上传.xslx文件，且不超过5M</div> -->
									  </el-upload>
								    <!-- <el-input v-model="form.type" placeholder="请选择数据集类别" /> -->
								  </el-form-item>

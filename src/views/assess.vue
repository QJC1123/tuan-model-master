				...
				<el-col :span="16" style="padding-left: 50px;padding-top: 50px;">
						...
						<el-row>
							<el-row>
								<div class="big_title" style="font-size: 20px;float:left;color: white;">
									<el-row>
										<span style="text-shadow: .3rem 0 0.3rem #00d8ff;">待评估模型</span>
									</el-row>
						...
						<el-row>
							...
							<div class=".regional_table">
								...
								>
								  ...
								  <el-table-column label="训练名称" align="center" prop="content" />
								  <el-table-column label="状态" align="center" prop="status" />
								  <el-table-column label="创建时间" align="center" prop="status" />
								  <!-- <el-table-column label="mAp" align="center" prop="percent" /> -->
					...
					<el-row style="padding-top: 40px;">
						<el-row>
							<div class="big_title" style="font-size: 20px;float:left;color: white;">
								<el-row>
									<span style="text-shadow: .3rem 0 0.3rem #00d8ff;">已评估模型</span>
								</el-row>
								<el-row style="padding-bottom: 20px;padding-top: 0px;">
									<el-col span="4">
										<img src="../assets/images/line1.png" style="width: 110%;padding-bottom: 5px;" />
								...
								<el-form ref="form" :model="form" :rules="rules" label-width="30px" style="padding-left: 0;">
								  ...
								  <el-form-item prop="type">
									  <router-link to="/assessdetail">
										  <el-button type="primary" @click="submitForm">开始评估</el-button>
									  </router-link>

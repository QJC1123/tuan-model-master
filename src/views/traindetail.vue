				...
				<el-col :span="16" style="padding-left: 50px;padding-top: 50px;">
						...
						<el-row>
							<el-row>
								<div class="big_title" style="font-size: 20px;float:left;color: white;">
									<el-row>
										<span style="text-shadow: .3rem 0 0.3rem #00d8ff;">基本信息</span>
									</el-row>
					...
					<el-row style="padding-top: 40px;">
						<el-row>
							<div class="big_title" style="font-size: 20px;float:left;color: white;">
								<el-row>
									<span style="text-shadow: .3rem 0 0.3rem #00d8ff;">训练结果</span>
								</el-row>
								<el-row style="padding-bottom: 20px;padding-top: 0px;">
									<el-col span="4">
										<img src="../assets/images/line1.png" style="width: 110%;padding-bottom: 5px;" />
				...
				<el-col :span="8" style="padding-top: 50px;padding-right: 30px;height: 700px;" >
					<el-row class="div1" style="height: 100%;width: 400px;">
						<el-row style="font-size: 16px;float:left;color: white;padding-top: 20px;padding-left: 10px;padding-right: 10px;">
							<span style="text-shadow: .3rem 0 0.3rem #00d8ff;padding-left: 140px;font-size: 19px;">训练参数配置</span>
							<div style="padding-top: 20px;zoom: 0.9;">
								<el-form ref="form" :model="form" :rules="rules" label-width="30px" style="padding-left: 0;">
								  <el-form-item prop="name">
								    ...
								    <el-input v-model="form.name" placeholder="请输入验证集比例" step="width:50px"/>
								  </el-form-item>
								  <el-form-item prop="content">
								  	<span style="font-size: 16px;">图片宽度</span>
								    <el-input v-model="form.content" placeholder="请输入" />
								  </el-form-item>
								  <el-form-item prop="source">
								  	<span style="font-size: 16px;">图片高度</span>
								    <el-input v-model="form.source" placeholder="请输入" />
								  </el-form-item>
								  <el-form-item prop="type">
								  	<span style="font-size: 16px;">批数量</span>
								    <el-input v-model="form.type" placeholder="请选择" />
								  </el-form-item>
								  <el-form-item prop="type">
								  	<span style="font-size: 16px;">最大迭代轮次</span>
